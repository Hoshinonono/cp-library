...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"Graph/dsu__max.hpp\"\ntemplate <class T> struct Kruskal_dsu\
    \ {\r\n    public:\r\n    Kruskal_dsu() : _n(0) {}\r\n    Kruskal_dsu(int n) :\
  ...
  path: Graph/dsu__max.hpp
  requiredBy: []
  timestamp: '2023-12-31 19:21:57+09:00'
  verificationStatus: LIBRARY_NO_TESTS
  verifiedWith: []
documentation_of: Graph/dsu__max.hpp
layout: document
redirect_from:
- /library/Graph/dsu__max.hpp
- /library/Graph/dsu__max.hpp.html
title: Graph/dsu__max.hpp
---
